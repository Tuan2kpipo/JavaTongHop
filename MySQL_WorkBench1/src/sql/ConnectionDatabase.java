...
public class ConnectionDatabase {
    ...
    private final String url = "jdbc:mysql://localhost:3306/dbsinhvien";
    private final String user = "root";
    private final String pass = "26122000";
    ...
    public void initConnection() {
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/dbsinhvien?useSSL=false", user, pass);
